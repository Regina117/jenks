...
public class OAuth2ResourceServerAuthProviderPanel
    ...
    private static Logger LOGGER = Logging.getLogger(OAuth2ResourceServerAuthProviderPanel.class);

    private GeoServerDialog dialog;

    public OAuth2ResourceServerAuthProviderPanel(
            String id, IModel<GeoServerOAuth2ResourceServerFilterConfig> model) {
        super(id, model);
        ...
        add(new TextField<String>("issuerUri"));
