...
public class GeoServerOAuth2ResourceServerAuthenticationProvider extends AbstractFilterProvider
    ...
    private static final List<Class<?>> REQ_FILTER_TYPES =
            asList(BearerTokenAuthenticationFilter.class);
    ...
    private class FilterBuilder {
        ...
        public FilterBuilder(
                GeoServerOAuth2ResourceServerFilterConfig pConfig, HttpSecurity pHttpSecurity) {
            super();
            config = pConfig;
            http = pHttpSecurity;
        }
    ...
    public GeoServerOAuth2ResourceServerAuthenticationProvider(
    ...
    public void configure(XStreamPersister xp) {
        xp.getXStream()
                .alias(
                        "oauth2ResourceServerAuthentication",
                        GeoServerOAuth2ResourceServerFilterConfig.class);
    }
    ...
    public GeoServerSecurityFilter createFilter(SecurityNamedServiceConfig config) {
        GeoServerOAuth2ResourceServerFilterConfig lConfig =
                (GeoServerOAuth2ResourceServerFilterConfig) config;
