...
public class GeoServerJwtAuthenticationConverter
    ...
    public AbstractAuthenticationToken convert(Jwt pSource) {
        ...
        GeoServerRoleResolvers.RoleResolver lResolver =
                GeoServerRoleResolvers.PRE_AUTH_ROLE_SOURCE_RESOLVER;
        Collection<GeoServerRole> lRoles =
                lResolver.convert(new ResolverParam(lPrincipal, null, roleResolverContext));
