...
/**
 * Defines interfaces for optional customizers, which might be used to tweak the OIDC login in a
 * specific way.
 *
 * @author awaterme
 */
public class GeoServerOAuth2LoginCustomizers {
    ...
    public interface FilterBuilderCustomizer
            extends Consumer<GeoServerOAuth2LoginAuthenticationFilterBuilder> {};
}
